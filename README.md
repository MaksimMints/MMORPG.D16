# MMORPG.D16
Учебная итоговая работа по разделу DJANGO. 
...
Вставка в текст объявления картинок и другого контента реализована с помощью ckeditor
Уведомления пользователей о создании и принятии отклива реализрваны через signal

Рассылка сообщения о новых объявлениях за последниюю неделю реализована через apscheduler.schedulers
